...
axes[0].grid()
axes[0].set_title('Varying Receiver for Fixed Sphere at 20m', fontsize=22)
axes[1].set_xlabel('Cell Refinement Around Receiver (m)', fontsize=20)
...
axes[0].text(60, 5.4, "(x,y) = (0,0)", fontsize=16, bbox=box)
axes[1].text(60, 5.4, "(x,y) = (-5000,0)", fontsize=16, bbox=box)
